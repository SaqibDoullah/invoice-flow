        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-4">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground mt-1 text-sm">{invoice.companyAddress}</p>
      ...
      <section className="mb-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-4">
          ...
          <div className="text-left md:text-right space-y-2">
            <div className="grid grid-cols-2 md:grid-cols-2 items-center gap-1">
                <span className="font-semibold">Invoice Date:</span>
                <span className="md:text-right">{format(invoice.invoiceDate.toDate(), 'PPP')}</span>
            </div>
             <div className="grid grid-cols-2 md:grid-cols-2 items-center gap-1">
                <span className="font-semibold">Due Date:</span>
                <span className="md:text-right">{format(invoice.dueDate.toDate(), 'PPP')}</span>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-2 items-center gap-1">
                <span className="font-semibold">Status:</span>
                <div className="flex justify-start md:justify-end"><StatusBadge status={invoice.status} /></div>
            </div>
          </div>
        </div>
      </section>
