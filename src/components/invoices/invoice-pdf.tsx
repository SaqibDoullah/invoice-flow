...
const InvoicePDF = React.forwardRef<HTMLDivElement, InvoicePDFProps>(({ invoice }, ref) => {
  ...
  return (
    <div ref={ref} className="text-foreground bg-card p-6 rounded-xl">
        ...
        <div className="grid grid-cols-2 gap-8 lg:gap-4">
          ...
          <div className="text-right space-y-2">
            <div className="grid grid-cols-2 items-center gap-1">
                ...
                <span className="text-right">{format(invoice.invoiceDate.toDate(), 'PPP')}</span>
            </div>
             <div className="grid grid-cols-2 items-center gap-1">
                <span className="font-semibold">Due Date:</span>
                <span className="text-right">{format(invoice.dueDate.toDate(), 'PPP')}</span>
            </div>
            <div className="grid grid-cols-2 items-center gap-1">
