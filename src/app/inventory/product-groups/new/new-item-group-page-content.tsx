...
import { Loader2, Trash2, Plus, Info, Image as ImageIcon, X } from 'lucide-react';
    ...
    return (
        <AuthGuard>
            <div className="fixed inset-0 bg-black/50 z-50">
                 <div className="fixed right-0 top-0 h-full w-full max-w-4xl bg-background shadow-lg overflow-y-auto">
                    <div className="p-6 border-b flex justify-between items-center">
                        <h2 className="text-xl font-semibold">New Item Group</h2>
                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(handleSubmit)} className="p-6 space-y-6">
                            ...
                            <div className="border-t pt-6">
                                <h3 className="font-semibold">Select your Item Type:</h3>
                                 <FormField
                                    control={form.control}
                                    name="itemType"
                                    render={() => (
